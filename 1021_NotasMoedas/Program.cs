...
class URI
{
    ...
    static void Main(string[] args)
    {
        ...
        System.Console.WriteLine(quociente + " moeda(s) de R$ 1.00");
        resto = resto % moedas;

        moedas = 50;
        quociente = resto / moedas;
        System.Console.WriteLine(quociente + " moeda(s) de R$ 0.50");
        resto = resto % moedas;

        moedas = 25;
        quociente = resto / moedas;
        System.Console.WriteLine(quociente + " moeda(s) de R$ 0.25");
        resto = resto % moedas;

        moedas = 10;
        quociente = resto / moedas;
        System.Console.WriteLine(quociente + " moeda(s) de R$ 0.10");
        resto = resto % moedas;

        moedas = 5;
        quociente = resto / moedas;
        System.Console.WriteLine(quociente + " moeda(s) de R$ 0.05");
        resto = resto % moedas;

        moedas = 1;
        quociente = resto / moedas;
        System.Console.WriteLine(quociente + " moeda(s) de R$ 0.01");
